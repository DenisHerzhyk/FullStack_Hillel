...
function sumArray(numbers) {
  let initialValue = 0
  const sumOfArray = numbers.reduce((prev, curr) => prev + curr, initialValue)
  return sumOfArray
}
...
//example of sum arrays in array

// function sumArraysInArray(numbers) {
//   let initialValue = 0
//   const sumOfArrays = numbers.reduce((sum, currentArray) => sum + currentArray.reduce((prev, curr) => prev + curr, initialValue),initialValue)
//   return sumOfArrays
// }
...
//   [3, 4, 5]
// ]
// const sumOfNumbers = sumArraysInArray(numbers)
// console.log('Сума елементів масиву:', sumOfNumbers) // Виведення суми
/*
 * #2
 *
...
class SkillsManager {
  ...
  addSkill(skill) {
    if (skill.length >= 2 && typeof skill === 'string') {
