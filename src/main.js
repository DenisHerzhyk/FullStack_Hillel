...
class CalorieCalculator {
  constructor() {
    self.productCalories = new Map()
  }

  addProduct(product, calories) {
    self.productCalories.set(product, calories)
  }

  getProductCalories(productName) {
    if (!self.productCalories.has(productName)) {
      return "Product not found"
    }
    return self.productCalories.get(productName)
  }
  ...
  removeProduct(productName) {
    ...
    self.productCalories.delete(productName)
  }
}
...
class UniqueUsernames {
  ...
  exists(username) {
    return self.users.has(username)
  }
